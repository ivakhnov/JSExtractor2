...
var pluginManager = function() {
	...
	this.startPlugin = function(pluginID, configJson, siteUrl, callback) {
		...
		plugin.start(configJson, siteUrl, function(err, result) {
			var error = null;
			if(err != null){
	...
	this.getDataPerspectives = function (pluginID) {
		var dataPerspectives = [
			1,
			2
		];
		return dataPerspectives;
	};
