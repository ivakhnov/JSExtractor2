...
var pluginManager = function() {
	...
	fs.readdir('./plugins', function(err, files){
		...
		for (var i in files) {
			...
			plugin.html = view.createForm(plugin.getInputForm());
	...
	this.startTool = function(toolID, formString, sites, callback) {
		var configJson = view.formFilledToJson(formString);
